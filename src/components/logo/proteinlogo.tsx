...
import { A, B, C, D, E, F, G, H, I, K, L, M, N, P, Q, R, S, T, V, W, Y, Z } from "../glyphs";
 ...
 */
const ProteinLogo = React.forwardRef((props, ref) => <Logo alphabet={ProteinAlphabet} {...props} ref={ref} />);
